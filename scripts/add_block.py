...
if args.parent:
	...
	if parent_uid is None:
		print(f"Error: Could not find or create parent block: {args.parent}")
		sys.exit(1)
else:
	parent_uid = page_uid
