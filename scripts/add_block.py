...
Usage:
    python add_block.py BLOCKTEXT [-pg PAGE] [-pb PARENT] [-o {first,last}]

Required:
    BLOCKTEXT    Text content of block(s). Use '\\n' to separate multiple blocks

Optional:
    -pg, --page     Target page (defaults to today's daily page)
                    Can be: YYYY-MM-DD, page title, or page UID
    -pb, --parent   Parent block text to nest under (created if not found)
    -o, --order     Block placement: 'first' or 'last' (default: last)
